...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // Check if we have a user (session) after signup
      // The useEffect will handle redirect if we do
    ...
    <div className="min-h-screen bg-animated flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="glass-card w-full max-w-md p-8 relative z-10 animate-scale-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Start organizing your thoughts with Mindmesh</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="text-sm text-gray-400">
            ...
            <Link href="/terms" className="text-accent-primary hover:text-accent-secondary transition-colors">
              Terms of Service
            </Link>{' '}
            and{' '}
            <Link href="/privacy" className="text-accent-primary hover:text-accent-secondary transition-colors">
              Privacy Policy
            </Link>
          </div>
